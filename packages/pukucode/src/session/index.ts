...
export namespace Session {
  ...
  // ===================================================================
  // STEP 2: UTILITIES - Session utility functions and constants
  // These would go in src/session/utils.ts in the modular structure
  // ===================================================================
  ...
  // Title generation utilities (STEP 2: UTILITIES)
  ...
  // ===================================================================
  // STEP 1: CORE TYPES & SCHEMAS - Session type definitions
  // These would go in src/session/types.ts in the modular structure
  // ===================================================================
  ...
  // Event definitions (STEP 1: CORE TYPES)
  export const Event = {
    Updated: Bus.event(
      "session.updated",
      z.object({
  ...
  // Session state management (STEP 2: UTILITIES)
  ...
  // ===================================================================
  // STEP 3: CRUD OPERATIONS - Session create, read, update, delete
  // These would go in src/session/crud.ts in the modular structure
  // ===================================================================
...
//   }
  ...
  // ===================================================================
  // STEP 4: MESSAGE MANAGEMENT - Message and parts handling
  // These would go in src/session/messages.ts in the modular structure
  // ===================================================================
  ...
  // Additional CRUD operations (STEP 3: CRUD)
  ...
  // Message update functions (STEP 4: MESSAGE MANAGEMENT)
  ...
  // Input schemas (STEP 1: CORE TYPES)
  ...
  // ===================================================================
  // STEP 5: PROMPT PROCESSING - Main chat processing pipeline (650+ lines)
  // This massive function would be broken into multiple modules:
  // - PromptProcessor class in src/session/processor.ts
  // - Stream processing in src/session/stream-processor.ts
  // - Tool management and file processing
  // ===================================================================
  ...
  // ===================================================================
  // ADDITIONAL FUNCTIONALITY: SHELL EXECUTION (140+ lines)
  // This would be extracted to a separate shell module
  // ===================================================================
  ...
  // ===================================================================
  // ADDITIONAL FUNCTIONALITY: COMMAND EXECUTION (75+ lines)
  // This would be extracted to a separate command module
  // ===================================================================
  ...
  // Utility regexes (STEP 2: UTILITIES)
  const bashRegex = /!`([^`]+)`/g
  /**
  ...
  // ===================================================================
  // STEP 6: STREAM PROCESSING - Stream processor factory (290+ lines)
  // This entire function would become src/session/stream-processor.ts
  // Contains all the stream event handling logic:
  // - text-delta, tool-call, tool-result, reasoning events
  ...
  // ===================================================================
  // ADDITIONAL FUNCTIONALITY: SESSION OPERATIONS (190+ lines)
  // These would be extracted to session utilities/helpers
  ...
  // ===================================================================
  // STEP 2: UTILITIES - Session locking and usage calculation
  // These utility functions would go in src/session/utils.ts
  // ===================================================================
  ...
  // ===================================================================
  // INITIALIZATION FUNCTION - Session initialization with default prompt
  // ===================================================================
