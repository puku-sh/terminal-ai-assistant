...
export namespace Server {
  ...
  export const App = lazy(() =>
    app
      ...
      // Session sharing and summarization endpoints commented out - not implemented yet
      ...
      .post(
        ...
        validator("json", Session.CommandInput.omit({ sessionID: true })),
        async (c) => {
          const sessionID = c.req.valid("param").id
          const body = c.req.valid("json")
      ...
      .post(
        ...
        validator("json", Session.ShellInput.omit({ sessionID: true })),
        async (c) => {
          const sessionID = c.req.valid("param").id
          const body = c.req.valid("json")
      ...
      .post(
        ...
        validator("json", Session.RevertInput.omit({ sessionID: true })),
        async (c) => {
      ...
      // Find endpoints commented out - LSP and Ripgrep not implemented yet
      // .get("/find", ...)
      // .get("/find/file", ...)
      // .get("/find/symbol", ...)
      .get(
