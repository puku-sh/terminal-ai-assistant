...
func Start(ctx context.Context, program *tea.Program, client *pukucode.Client) {
	for {
		select {
		case <-ctx.Done():
			return
...
func Reply(ctx context.Context, client *pukucode.Client, response interface{}) tea.Cmd {
	return func() tea.Msg {
